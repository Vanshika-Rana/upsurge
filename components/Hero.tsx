	...
	return (
		<div className="bg-[url('/herobg.png')] bg-cover bg-center h-[90vh] flex items-center justify-center">
			<div className='text-center px-4 sm:px-6 md:px-12 lg:px-24'>
				<div className='text-sm sm:text-md font-bold text-blue-600 uppercase mb-4 font-body'>
					Welcome to Upsurge Labs
				</div>
				<h1 className='text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal text-gray-900 leading-tight mb-6 font-display'>
				...
				<button className='bg-blue-600 text-white py-3 px-6 sm:px-8 rounded-lg text-sm sm:text-md md:text-lg font-semibold transition duration-200 ease-in-out hover:scale-95 font-body'>
					Contact Us
				</button>
			</div>
		</div>
